...
exports.generateVideoUrl = exports.deleteCourse = exports.getAllUsers = exports.addReplyToReview = exports.addReview = exports.addAnswer = exports.addQuestion = exports.getCourseByUser = exports.getAllCourse = exports.getSingleCourse = exports.editCourse = exports.uploadCourse = void 0;
...
exports.getSingleCourse = (0, catchAsyncError_1.catchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (isCacheExist) {
            ...
            const course = await course_model_1.default.findById(req.params.id).select("-courseData.demoUrl -courseData.suggestion -courseData.questions -courseData.links");
...
exports.getAllCourse = (0, catchAsyncError_1.catchAsyncError)(async (req, res, next) => {
    try {
        const courses = await course_model_1.default.find().select("-courseData.demoUrl -courseData.suggestion -courseData.questions -courseData.links");
        res.status(200).json({
            success: true,
            courses,
        });
...
exports.generateVideoUrl = (0, catchAsyncError_1.catchAsyncError)(async (req, res, next) => {
    try {
        ...
        const response = await axios_1.default.post(`https://dev.vdocipher.com/api/videos/${videoId}/otp`, { ttl: 330 }, {
            headers: {
