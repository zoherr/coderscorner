...
const SuggestionCourseCard: FC<Props> = ({ item, isProfile }) => {
    return (
        <>
            <motion.div
                variants={{
            ...
            >
                <div className=''>
                    ...
                    <div className="">
                        ...
                        <div className={` grid grid-cols-2 rounded-sm gap-2 py-2  items-center `}>
                            <p className="text-lg   pl-[38%]  text-black dark:text-white font-light">Price</p>
                            <h1 className="pl-0 text-center text-[#24CFA6] text:bg-blue-500 text-[20px]">₹{item.price}</h1></div>
                        {/* <p className="px-4 line-clamp-3">{item.price}</p> */}
                    </div>
...
export default SuggestionCourseCard