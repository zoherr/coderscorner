            ...
            >
              <div className="flex items-center justify-end xl:justify-between">
                ...
                <a
                  ...
                  className="cursor-no-drop inline-flex items-center gap-2.5 rounded-full bg-black px-6 py-3 font-medium text-white hover:opacity-90 dark:bg-white dark:text-black"
                >
                  Sign up free
                  <Image
                    width={20}
