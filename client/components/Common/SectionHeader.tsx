    ...
    <>
      ...
      >
        <div className="mb-4 inline-block rounded-full bg-zumthor px-4.5 py-1.5 dark:border dark:border-strokedark dark:bg-blacksection">
          <span className="text-sectiontitle font-medium text-black dark:text-white subHeader_label">
            {title}
          </span>
        </div>
        ...
        <p className="mx-auto md:w-4/5 lg:w-3/5 xl:w-[46%] subHeader_label">{description}</p>
      </motion.div>
      {/* <!-- Section Title End --> */}
    </>
  );
